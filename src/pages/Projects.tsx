...
const projectDetails = {
  ...
  galleryImages: ["https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?q=80&w=600&auto=format&fit=crop", "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?q=80&w=600&auto=format&fit=crop", "https://images.unsplash.com/photo-1472396961693-142e6e269027?q=80&w=600&auto=format&fit=crop", "public/lovable-uploads/b3d2111c-5350-4a7b-9f69-75764f222636.png", "public/lovable-uploads/098d94c9-59dc-4495-82af-c5a7ef37fe75.png"],
  features: [{
    icon: TreePine,
      ...
      <section className="py-16">
        <div className="container-custom mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <img src={projectDetails.mainImage} alt="Nature Valley Development" className="w-full h-[500px] object-cover rounded-lg shadow-lg" />
            </div>
            <div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <img src={projectDetails.clubhouse.image} alt="Nature Valley Clubhouse" className="w-full rounded-lg shadow-md hover:shadow-xl transition-all" />
                </div>
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Fitness center, recreational areas and swimming pool</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="h-6 w-6 rounded-full bg-secondary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-secondary text-sm">✓</span>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projectDetails.galleryImages.map((image, index) => <img key={index} src={image} alt={`Nature Valley Gallery ${index + 1}`} className="w-full h-64 object-cover rounded-lg shadow-md hover:shadow-lg transition-shadow" />)}
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <img src="public/lovable-uploads/b3d2111c-5350-4a7b-9f69-75764f222636.png" alt="Nature Valley Layout Plan" className="w-full rounded-lg" />
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {projectDetails.features.map((feature, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-md">
